...
public class MaterialCalendarView extends ViewGroup {
    ...
    List<CalendarDay> calendarDaysDisableTemp;

    Calendar calendarDaysMaximumTemp;
    ...
    protected void onDateClicked(@NonNull CalendarDay date, boolean nowSelected) {
        switch (selectionMode) {
            ...
            default:
            case SELECTION_MODE_SINGLE: {
                if (calendarDaysDisableTemp == null) {
                    calendarDaysDisableTemp = new ArrayList<>();
                }

                if (calendarDaysMaximumTemp != null) {
                    if (calendarDaysMaximumTemp.getTime().before(date.getDate())) {
                        break;
                    }
                }

                if (calendarDaysDisableTemp.contains(date)) {
                    break;
                } else {
                    adapter.clearSelections();
    ...
    public void addAllDisableDays(List<CalendarDay> calendarDays) {
        if (calendarDaysDisableTemp == null) {
            calendarDaysDisableTemp = new ArrayList<>();
        }
        calendarDaysDisableTemp.addAll(calendarDays);
    }

    public void setMaximumDataCustom(Calendar calendarDaysMaximumTemp) {
        this.calendarDaysMaximumTemp = calendarDaysMaximumTemp;
    }
