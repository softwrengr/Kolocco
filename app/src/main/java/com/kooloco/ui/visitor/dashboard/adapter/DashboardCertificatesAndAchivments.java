...
public class DashboardCertificatesAndAchivments extends RecyclerView.Adapter<DashboardCertificatesAndAchivments.ViewHolder> {
    Context context;
    List<CertificateInfo> certificateInfos;
    CallBack callBack;


    public DashboardCertificatesAndAchivments(Context context, List<CertificateInfo> certificateInfos, CallBack callBack) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.row_dashboard_certificate_archivment_image, parent, false));
    }
