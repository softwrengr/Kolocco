...
public class DashboardServiceAdapter extends RecyclerView.Adapter<DashboardServiceAdapter.ViewHolder> {
    ...
    public DashboardServiceAdapter(Context context, List<Service> services, CallBack callBack) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.row_dashboard_service_image, parent, false));
    }
