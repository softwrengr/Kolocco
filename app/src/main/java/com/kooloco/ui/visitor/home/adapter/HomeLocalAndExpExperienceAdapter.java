...
public class HomeLocalAndExpExperienceAdapter extends RecyclerView.Adapter<HomeLocalAndExpExperienceAdapter.ViewHolder> {
    Context context;
    CallBack callBack;
    ...
    public HomeLocalAndExpExperienceAdapter(Context context, List<ExpereinceNew> expereinceNews, CallBack callBack) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.home_local_and_exp_row_exp, parent, false));
    }
