...
public class SelectActivitiesNewAdapter extends RecyclerView.Adapter<SelectActivitiesNewAdapter.ViewHolder> {
    Context context;
    List<Activities> activities;
    private CallBack callBack;
    int selectPosition = -1;

    public SelectActivitiesNewAdapter(Context context, List<Activities> activities,int selectPosition,CallBack callBack) {
