...
import com.kooloco.ui.visitor.organizationDetails.presenter.MettingLocationPresenter;
...
public class MettingLocationFragment extends BaseFragment<MettingLocationPresenter, MettingLocationView> implements MettingLocationView, OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    GoogleMap gMap;
    ...
    @Override
    protected MettingLocationView createView() {
        return this;
    }
    ...
    private void openMap() {
        ...
        mapFragment.getMapAsync(MettingLocationFragment.this);
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng latLng1 = new LatLng(Double.parseDouble(dashboardDetails.getLatitude()), Double.parseDouble(dashboardDetails.getLongitude()));

        gMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.map_current_location_icon)).draggable(false).position(latLng1));
