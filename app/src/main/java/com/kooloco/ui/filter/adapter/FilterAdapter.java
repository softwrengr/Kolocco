...
public class FilterAdapter extends RecyclerView.Adapter<FilterAdapter.ViewHolder> {
    ...
    public FilterAdapter(Context context, List<String> name, CallBack callBack) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        holder.customTextViewName.setText(name.get(position));
        holder.customTextViewName.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                callBack.onClickSelect(position);
            }
        });
    }
