...
public class VideoTimelineView extends View {
    ...
    private boolean checkFromRight() {
        ...
        float diff = progressRight - progressLeft;
        Log.e("Diff ", " " + diff);
        if (diff > max) {
            Log.e("Right ", " " + progressLeft);
            progressLeft = progressLeft + (diff - max);
            delegate.onLeftProgressChanged(progressLeft);
            invalidate();
            return false;
        }
    ...
    private boolean checkFromLeft() {
        ...
        Log.e("Diff ", " " + diff);
        if (diff > max) {
            Log.e("Left ", " " + progressRight);
            progressRight = progressRight - (diff - max);
            delegate.onRifhtProgressChanged(progressRight);
            invalidate();
            return false;
        }
    ...
    public void setVideoPath(String path, int maxLength) {
        ...
        try {
            ...
            max = (float) this.maxLength / videoLength;
            Log.e("Max lenght ", " " + max);
            progressRight = max;
            invalidate();
        } catch (Exception e) {
