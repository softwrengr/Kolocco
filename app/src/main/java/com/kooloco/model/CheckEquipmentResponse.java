...
public class CheckEquipmentResponse {
    ...
    @SerializedName("equipment_check_list")
    @Expose
    private List<CheckEquipment> equipments = null;
    ...
    public List<CheckEquipment> getEquipments() {
        return equipments;
    }

    public void setEquipments(List<CheckEquipment> equipments) {
