...
public class PlaceAutocompleteAdapter
    ...
    private static final String TAG = "PlaceAC";
    Context context;
...
// styling based on the given CharacterStyle.
        ...
        try {
            ...
            AutocompletePrediction item = null;
...
// Confirm that the query completed successfully, otherwise return null
            ...
            if (!status.isSuccess()) {
                Log.e(TAG, "Error getting autocomplete prediction API call: " + status.getStatusMessage());
