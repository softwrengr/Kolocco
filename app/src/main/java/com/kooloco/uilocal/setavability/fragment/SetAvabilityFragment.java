...
import com.kooloco.uilocal.setavability.presenter.SetAvabilityPresenter;
...
public class SetAvabilityFragment extends BaseFragment<SetAvabilityPresenter, SetAvabilityView> implements SetAvabilityView {
    int flag = 1;
    String startDate = "";
    String endDate = "";
    int h = 0;
    ...
    protected int createLayout() {
        return R.layout.fragment_local_set_availabilitie;
    }
    ...
    @Override
    protected SetAvabilityView createView() {
        return this;
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.buttonSave:
                presenter.callWs(getSetAvailability(),isEdit);
                break;
        }
    }
    ...
    @OnClick({R.id.customTextDisableSport, R.id.customTextSetSpecialAvaibility})
    public void onViewClickedNutton(View view) {
        switch (view.getId()) {
            case R.id.customTextDisableSport:
                presenter.openDisableSport();
                break;
            case R.id.customTextSetSpecialAvaibility:
                presenter.openSetSpecialAvaibility();
                break;
        }
    }
    ...
    @Override
    public void setData(List<SchduleDashboard> data) {
        for (SchduleDashboard schduleDashboard : data) {


            if (schduleDashboard.getDay() != null) {
                if (schduleDashboard.getDay().equalsIgnoreCase("Mon")) {
                    customTextViewStartTime1.setText(TimeConvertUtils.dateTimeConvertLocalToLocal(schduleDashboard.getStartTime(), "HH:mm:ss", "hh:mm a"));
                    customTextViewEndTime1.setText(TimeConvertUtils.dateTimeConvertLocalToLocal(schduleDashboard.getEndTime(), "HH:mm:ss", "hh:mm a"));
                }

                if (schduleDashboard.getDay().equalsIgnoreCase("Tue")) {
                    customTextViewStartTime2.setText(TimeConvertUtils.dateTimeConvertLocalToLocal(schduleDashboard.getStartTime(), "HH:mm:ss", "hh:mm a"));
                    customTextViewEndTime2.setText(TimeConvertUtils.dateTimeConvertLocalToLocal(schduleDashboard.getEndTime(), "HH:mm:ss", "hh:mm a"));
                }

                if (schduleDashboard.getDay().equalsIgnoreCase("Wed")) {
                    customTextViewStartTime3.setText(TimeConvertUtils.dateTimeConvertLocalToLocal(schduleDashboard.getStartTime(), "HH:mm:ss", "hh:mm a"));
                    customTextViewEndTime3.setText(TimeConvertUtils.dateTimeConvertLocalToLocal(schduleDashboard.getEndTime(), "HH:mm:ss", "hh:mm a"));
                }

                if (schduleDashboard.getDay().equalsIgnoreCase("Thu")) {
                    customTextViewStartTime4.setText(TimeConvertUtils.dateTimeConvertLocalToLocal(schduleDashboard.getStartTime(), "HH:mm:ss", "hh:mm a"));
                    customTextViewEndTime4.setText(TimeConvertUtils.dateTimeConvertLocalToLocal(schduleDashboard.getEndTime(), "HH:mm:ss", "hh:mm a"));
                }

                if (schduleDashboard.getDay().equalsIgnoreCase("Fri")) {
                    customTextViewStartTime5.setText(TimeConvertUtils.dateTimeConvertLocalToLocal(schduleDashboard.getStartTime(), "HH:mm:ss", "hh:mm a"));
                    customTextViewEndTime5.setText(TimeConvertUtils.dateTimeConvertLocalToLocal(schduleDashboard.getEndTime(), "HH:mm:ss", "hh:mm a"));
                }

                if (schduleDashboard.getDay().equalsIgnoreCase("Sat")) {
                    customTextViewStartTime6.setText(TimeConvertUtils.dateTimeConvertLocalToLocal(schduleDashboard.getStartTime(), "HH:mm:ss", "hh:mm a"));
                    customTextViewEndTime6.setText(TimeConvertUtils.dateTimeConvertLocalToLocal(schduleDashboard.getEndTime(), "HH:mm:ss", "hh:mm a"));
                }
                if (schduleDashboard.getDay().equalsIgnoreCase("Sun")) {
                    customTextViewStartTime7.setText(TimeConvertUtils.dateTimeConvertLocalToLocal(schduleDashboard.getStartTime(), "HH:mm:ss", "hh:mm a"));
                    customTextViewEndTime7.setText(TimeConvertUtils.dateTimeConvertLocalToLocal(schduleDashboard.getEndTime(), "HH:mm:ss", "hh:mm a"));
                }
            }
