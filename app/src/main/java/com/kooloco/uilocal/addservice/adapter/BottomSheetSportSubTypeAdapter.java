...
public class BottomSheetSportSubTypeAdapter extends RecyclerView.Adapter<BottomSheetSportSubTypeAdapter.ViewHolder> {
    Context context;
    List<SportSubActivity> sportActivities;
    private CallBack callBack;

    public BottomSheetSportSubTypeAdapter(Context context, List<SportSubActivity> sportActivities, CallBack callBack) {
    ...
    public interface CallBack {
        ...
        void onClickSelect(SportSubActivity sportActivity);
