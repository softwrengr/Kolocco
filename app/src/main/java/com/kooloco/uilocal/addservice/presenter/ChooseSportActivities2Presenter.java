...
@PerActivity
public class ChooseSportActivities2Presenter extends BasePresenter<ChooseSportActivities2View> {
    @Inject
    ...
    @Inject
    public ChooseSportActivities2Presenter() {
    ...
    public void openCheckEquipments() {
