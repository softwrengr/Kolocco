...
public class ChooseSportSubActivityNewAdapter extends RecyclerView.Adapter<ChooseSportSubActivityNewAdapter.ViewHolder> {
    Context context;
    List<SportSubActivity> sportSubActivities;
    CallBack callBack;


    public ChooseSportSubActivityNewAdapter(Context context, List<SportSubActivity> sportSubActivities, CallBack callBack) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.row_local_check_sport_activities_new, parent, false));
    }
