...
import com.kooloco.uilocal.organaization.presenter.OrgAddBankPresenter;
...
public class OrgAddBankFragment extends BaseFragment<OrgAddBankPresenter, OrgAddBankView> implements OrgAddBankView {
    ...
    private OrgBankSetPaymentRules orgBankSetPaymentRules;
    private String orgId;

    @Override
    protected int createLayout() {
        return R.layout.fragment_local_org_add_bank;
    }
    ...
    @Override
    protected OrgAddBankView createView() {
        return this;
    }
    ...
    protected void bindData() {
        ...
        strings12.add("Individuals");
        strings12.add("Individual Entrepreneur");
            ...
            case R.id.buttonSubmit:
                ...
                try {
                    ...
                    presenter.callWs(isEdit,
                            ...
                            dateOfBirth,
                            selectImagePath, orgBankSetPaymentRules, orgId, countryId, map, editTextAdditionalInstructions.getText().toString().trim());
    ...
    @Override
    public void setAddBankPayment(OrgBankSetPaymentRules orgBankSetPaymentRules) {
        this.orgBankSetPaymentRules = orgBankSetPaymentRules;
    }
