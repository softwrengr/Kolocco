...
public class OrgAddLocalListAdapter extends RecyclerView.Adapter<OrgAddLocalListAdapter.ViewHolder> {
    Context context;
    private List<OrgLocal> orgLocals;

    public OrgAddLocalListAdapter(Context context, List<OrgLocal> orgLocals) {
