...
public class ExpSelectSportServiceSubNewAdapter extends RecyclerView.Adapter<ExpSelectSportServiceSubNewAdapter.ViewHolder> {
    Context context;
    List<SportSubActivity> subServices;
    SportActivity service;
    int selectPosition = -1;
    CallBack callBack;

    public ExpSelectSportServiceSubNewAdapter(Context context, List<SportSubActivity> subServices, SportActivity service, int selectPosition, CallBack callBack) {
    ...
    public interface CallBack {
        void onClickItem(int position, SportSubActivity subService, SportActivity service);
    }
}
